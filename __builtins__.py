...
class Leaderboards:
    Cactus: Leaderboard
    """Farm 33 554 432 cacti with multiple drones."""

    Cactus_Single: Leaderboard
    """Farm 131 072 cacti with a single drone on an 8x8 farm."""

    Carrots: Leaderboard
    """Farm 2 000 000 000 carrots with multiple drones."""

    Carrots_Single: Leaderboard
    """Farm 100 000 000 carrots with a single drone on an 8x8 farm."""

    Dinosaur: Leaderboard
    """Farm 33 488 928 bones with multiple drones."""
